...
| S-10 | report-export               | eksportować raport HTML i zrzut JPG z wizualizacją chromosomów                          | S-05                 | FR-009                          | done     |
...
- **S-10: użytkownik eksportuje samodzielny raport HTML i zrzut JPG z wizualizacją chromosomów** — Archived 2026-06-10 → `context/archive/2026-06-10-report-export/`. Lesson: —.
